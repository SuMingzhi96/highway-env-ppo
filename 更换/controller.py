...
class ControlledVehicle(Vehicle):
    ...
    def steering_control(self, target_lane_index: LaneIndex) -> float:
        ...
        # lateral_speed_command = - self.KP_LATERAL * lane_coords[1] * self.beilv
        lateral_speed_command = - lane_coords[1] * (self.beilv + 0.4)
        # print("collision_reward", self.config["collision_reward"])
...
class MDPVehicle(ControlledVehicle):
    ...
    DEFAULT_TARGET_SPEEDS = np.linspace(5, 11, 3)
